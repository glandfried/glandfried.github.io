...
\tikz{ %
         ...
         \node[factor, minimum size=1cm] (p1) {\includegraphics[width=0.025\textwidth]{../auxiliar/images/cerradura.png}} ;
         \node[det, minimum size=1cm, xshift=1.5cm] (p2) {\includegraphics[width=0.03\textwidth]{../auxiliar/images/dedo.png}} ;
